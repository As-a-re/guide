...
import { Plus, Pencil, X, AlertCircle, Calendar, Clock, Filter, Trash2, ChevronDown } from "lucide-react";
...
const AnnouncementsPage = () => {
  ...
  useEffect(() => {
    ...
    if (savedAnnouncements) {
      ...
      // Default announcements if none exist in localStorage
      const defaultAnnouncements = [
        {
          id: 1,
          title: "Church Meeting",
          content: "Annual church meeting scheduled for next Sunday after service. All members are encouraged to attend as we'll be discussing the upcoming plans for our church community and missions.",
          date: "2025-06-15",
          priority: "high",
        ...
        },
        {
          ...
          content: "Youth conference scheduled for next month. Please register your children by the end of this week. The theme is 'Faith in Action' and we'll have guest speakers from around the country.",
          date: "2025-07-10",
          priority: "medium",
          createdAt: new Date().toISOString(),
        },
        {
          ...
          content: "Extra worship team practice this Saturday at 4 PM. All instrumentalists and vocalists please be punctual as we'll be learning new songs for the upcoming service.",
          date: "2025-06-13",
          priority: "low",
          createdAt: new Date().toISOString(),
        },
