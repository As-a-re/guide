...
const App = () => {
  ...
  const {sidebarCollapsed, setSidebarCollapsed, mobileMenuOpen, setMobileMenuOpen} = useSidebar()
    ...
    <div className="app-container">
          ...
          <div className="logo-section">
            <Link to="/" className="logo-link">
              <div className="logo-container">
                <img src={process.env.PUBLIC_URL + "/logo.png"} alt="Church Logo" className="logo" />
      ...
      <main className={`main-content ${sidebarCollapsed ? "sidebar-collapsed" : ""}`}>
        {showTopNavBar && (
          <div
            className="bg"
            style={{
              backgroundImage: `url(${process.env.PUBLIC_URL + "/b.jpg"})`,
      ...
      <style jsx global>{`
        ...
        * {
        ...
        .bg {
          /* background-image removed for universal compatibility */
